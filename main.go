...
// Шаблон для GUI (OnePage) простенький лежит в папке templates,в корне. чтобы проверить с шаблоном - необходимо подкинуть свой IP сервера. вставка {{.}} в код js - почему-то у меня не срабатывает(( Решил забиндить в код.
